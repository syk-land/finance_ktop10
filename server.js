...
const COMPANY_DART_MOCK = {
  samsung: [
    { date: '2026-05-15', title: '분기보고서 (2026.03)', reporter: '삼성전자', content: '매출액 78.5조원, 영업이익 10.2조원 기록. AI 반도체 HBM 사업부 매출이 전년 동기 대비 140% 성장하며 실적 호조 견인. 파운드리 부문 수율 개선으로 적자 폭 대폭 축소.', summary: '매출 78.5조원 달성 및 AI HBM 140% 고성장 실적 호조.' },
    { date: '2026-04-20', title: '특허 취득 (반도체 패키징 기술)', reporter: '삼성전자', content: '3D 실리콘 관통전극(TSV)을 활용한 초고대역폭 메모리 적층 특허 취득. 차세대 AI 가속기 시장의 독점적 기술 우위 확보를 목적으로 함.', summary: '차세대 AI 반도체용 HBM 적층 TSV 특허 취득.' },
    { date: '2026-03-12', title: '주주총회결과', reporter: '삼성전자', content: '사내이사 선임의 건 및 배당금 총액 9.8조원 배당 안건 원안대로 가결. 온디바이스 AI 및 스마트가전 연계 생태계 확장 계획 발표.', summary: '9.8조원 배당 가결 및 온디바이스 AI 생태계 확장.' }
  ],
  skhynix: [
    { date: '2026-05-15', title: '분기보고서 (2026.03)', reporter: 'SK하이닉스', content: '매출액 15.2조원, 영업이익 3.2조원 달성. 고성능 HBM3E 및 서버용 DDR5 판매 호조로 어닝 서프라이즈 기록. 순이익 2.1조원으로 흑자 턴어라운드 안착.', summary: '영업익 3.2조 달성 및 HBM3E 공급 확대로 흑자 안착.' },
    { date: '2026-04-10', title: '단일판매ㆍ공급계약체결 (AI 가속기용 메모리)', reporter: 'SK하이닉스', content: '글로벌 주요 테크사향 차세대 AI 가속기용 HBM 대규모 장기 공급 계약 체결. 계약 금액은 경영상 비밀로 유보하였으나 직전 매출액의 15% 이상으로 추정.', summary: '글로벌 테크기업에 차세대 HBM 대규모 장기 공급 성사.' },
    { date: '2026-03-25', title: '주주총회결과', reporter: 'SK하이닉스', content: '재무제표 승인 및 신임 사외이사 선임 완료. 초고다층 3D NAND 개발 및 첨단 패키징 설비 확충을 위한 투자 재원 확보 승인.', summary: '첨단 패키징 설비 투자 및 고다층 3D NAND 개발 승인.' }
  ],
  hyundai: [
    { date: '2026-05-15', title: '분기보고서 (2026.03)', reporter: '현대자동차', content: '매출액 42.1조원, 영업이익 3.9조원 기록. 북미 및 유럽향 하이브리드(HEV) 차량 판매 급증 및 고부가가치 제네시스 차종 비중 확대로 이익률 방어 성공.', summary: '영업익 3.9조 달성 및 하이브리드(HEV) 차량 판매 급증.' },
    { date: '2026-04-05', title: '신규시설투자계획 (친환경 라인 증설)', reporter: '현대자동차', content: '미국 조지아 메타플랜트 내에 하이브리드 전용 생산 라인 증설 결정. 총 투자 금액 8,500억 원 규모로 친환경차 수요 다변화 대응 목적.', summary: '미국 조지아 공장에 8,500억 규모 하이브리드 라인 증설.' }
  ],
  samsungbiologics: [
    { date: '2026-05-15', title: '분기보고서 (2026.03)', reporter: '삼성바이오로직스', content: '매출액 9,800억원, 영업이익 3,100억원 기록. 4공장 가동률 상승 및 글로벌 제약사 수주 물량 확대. 부채비율 60% 이하로 재무안전성 유지.', summary: '매출 9,800억 및 4공장 활성화로 재무 안정성 견고.' },
    { date: '2026-04-18', title: '단일판매ㆍ공급계약체결 (의약품 위탁생산)', reporter: '삼성바이오로직스', content: '미국 소재 글로벌 제약사와 3,400억 원 규모의 바이오 의약품 위탁생산(CMO) 계약 체결. 5공장 조기 가동 로드맵에 따른 추가 캐파 확보 완료.', summary: '미국 제약사와 3,400억 규모 의약품 위탁생산 계약 체결.' }
  ],
  kia: [
    { date: '2026-05-15', title: '분기보고서 (2026.03)', reporter: '기아', content: '매출액 26.2조원, 영업이익 2.8조원 달성. 미국 레저용 차량(RV) 중심 판매 믹스 개선 및 친환경차 인센티브 하락으로 분기 사상 최대 이익률 달성.', summary: '미국 RV 차량 판매 호조로 분기 사상 최대 이익률 경신.' }
  ],
  celltrion: [
    { date: '2026-05-15', title: '분기보고서 (2026.03)', reporter: '셀트리온', content: '매출액 6,200억원, 영업이익 1,500억원 기록. 자가면역질환 치료제 램시마SC의 미국 짐펜트라 신규 런칭 매출 본격화. 마진율 24% 수준 회복.', summary: '미국 짐펜트라 신규 런칭 매출 본격화로 마진율 24% 회복.' }
  ],
  kbfg: [
    { date: '2026-05-15', title: '분기보고서 (2026.03)', reporter: 'KB금융', content: '당기순이익 1.2조원 기록. 비이자이익 수수료 부문 회복 및 선제적 대손충당금 적립 완료. 보통주자본(CET1) 비율 13.5%로 주주환원 확대 가능.', summary: '순이익 1.2조 달성 및 자본비율 개선으로 주주환원 확대.' }
  ],
  posco: [
    { date: '2026-05-15', title: '분기보고서 (2026.03)', reporter: 'POSCO홀딩스', content: '매출액 18.9조원, 영업이익 8,900억원 기록. 철강 시황 회복 지연에 따라 실적이 다소 횡보하였으나 리튬 등 이차전지 소재 공장 순차 가동 개시.', summary: '영업익 8,900억 기록 및 이차전지 소재 신공장 가동 개시.' }
  ],
  naver: [
    { date: '2026-05-15', title: '분기보고서 (2026.03)', reporter: 'NAVER', content: '매출액 2.5조원, 영업이익 4,200억원 기록. 서치플랫폼 검색 광고 매출 회복 및 AI 기반 맞춤형 타겟 광고 고도화 성공. 네이버웹툰 글로벌 유료 가입자 성장세 유지.', summary: '매출 2.5조원 달성 및 AI 맞춤 광고 고도화 성공.' }
  ],
  lgchem: [
    { date: '2026-05-15', title: '분기보고서 (2026.03)', reporter: 'LG화학', content: '매출액 12.8조원, 영업이익 4,500억원 기록. 석유화학 범용 스프레드 악화에도 불구하고 첨단소재 양극재 물량 본격 양산으로 실적 방어 성공.', summary: '영업익 4,500억 달성 및 배터리 양극재 본격 양산으로 실적 방어.' }
  ]
};
