...
| **verify** | 임시 DOM 스텁 스모크 테스트(키 구성·imgStyle flip·폴백·onload·양 POV 모드 좌타/우투·playPitch 무에러) 후 제거. `probe.mjs` 회귀 통과. **시각 렌더(전경 크기/위치·스윙 모양)는 브라우저 실기 확인 필요** — 샌드박스 브라우저 부재. |
